...
import { HostTile, RuntimeSignal } from "@/components/continuity-primitives";
    ...
    <div className="space-y-6">
      <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <Panel title={locale === "zh" ? "Work Plane Status" : "Work Plane Status"} eyebrow="Runtime">
          ...
          <div className="mt-5 rounded-[24px] border border-void-700 bg-[linear-gradient(180deg,rgba(15,23,42,0.58),rgba(2,6,23,0.88))] px-5 py-5">
            ...
            <div className="mt-4 rounded-[20px] border border-void-700 bg-black/20 px-4 py-4 text-sm leading-7 text-ink-muted">
          ...
          <Panel title={locale === "zh" ? "Local Projection" : "Local Projection"} eyebrow="~/Traceplane">
            <div className="space-y-4 text-sm leading-7 text-ink-muted">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="rounded-[20px] border border-void-700 bg-white/5 px-4 py-4">
                  <div className="text-[11px] uppercase tracking-[0.18em] text-ink-ghost">
      ...
      <ContinuityLaunchpad
        ...
        secondaryHref={`/${locale}/connect`}
        secondaryLabel={locale === "zh" ? "查看接入台" : "Open connect console"}
      />
