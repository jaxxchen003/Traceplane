...
MVP 不需要很多页面。建议只做下面 5 个页面或 5 个主视图。

### 3.1 Project List
**用途**
- 展示当前有哪些项目
- 作为 manager 进入系统的第一入口
...
### 5.1 从 Project 进入 Episode
用户点击某个项目，看到最近 episode，进入单条任务复盘。

### 5.2 从 Timeline 点回来源 Memory
用户在 trace 中点开一次决策，能知道它用了哪些上下文。

### 5.3 从 Artifact 回链到来源过程
