...
做一个面向企业多 Agent 协作场景的最小工作资产中心，让多个 Agent 围绕同一条 `episode` 主线共享上下文、过程和产物，并让管理者能查看、审计和复盘。
...
目标：证明这是“多 Agent 工作图谱”，不是单 Agent 存储层。
...
- 可以查询某个 episode 的上下文图

### 对管理者
- 可以看到某个项目下的 episodes 列表
