...
export function AppShell({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="pointer-events-none absolute right-[-8%] top-[12%] h-[420px] w-[420px] rounded-full bg-amber-400/10 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-[1600px] gap-6 px-4 py-6 lg:px-8">
        <aside className="hidden w-80 shrink-0 rounded-[36px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,15,32,0.95),rgba(2,6,23,0.98))] p-6 text-slate-50 shadow-[0_24px_90px_rgba(2,6,23,0.45)] lg:block">
          <div className="mb-10">
            <div className="inline-flex items-center gap-3 rounded-full border border-cyan-400/24 bg-cyan-400/10 px-3 py-1.5 text-[10px] uppercase tracking-[0.3em] text-cyan-100">
              <span className="flex h-5 w-5 items-center justify-center rounded-full border border-cyan-300/30 bg-[radial-gradient(circle_at_35%_35%,rgba(165,243,252,0.95),rgba(8,145,178,0.9))] text-[9px] font-semibold text-slate-950 shadow-[0_0_30px_rgba(34,211,238,0.28)]">
                T
              </span>
          ...
          <header className="mb-6 flex flex-col gap-4 rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(15,23,42,0.72),rgba(2,6,23,0.88))] px-5 py-4 shadow-[0_24px_80px_rgba(2,6,23,0.32)] backdrop-blur xl:flex-row xl:items-center xl:justify-between">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <div className="rounded-full border border-amber-400/25 bg-amber-400/10 px-3 py-1 text-xs uppercase tracking-[0.18em] text-amber-100">
                  Control plane
                </div>
              </div>
            </div>
